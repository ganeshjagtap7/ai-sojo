...
export interface RawLead {
  ...
  source: 'google_maps' | 'web_search' | 'bbb' | 'yellowpages' | 'manta' | 'startupage' | 'apppeak' | 'quietlight' | 'websiteclosers' | 'investorsclub' | 'motioninvest' | 'microns' | 'synergy' | 'businessdeals' | 'exitbid' | 'sideprojectors' | 'indiabiz' | 'buybiz' | 'mergerdomo' | 'tobuz' | 'smedealz' | 'businessex' | 'directory';
